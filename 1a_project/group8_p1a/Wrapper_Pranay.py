...
for dataset_num in range(1, 2):
    ...
    try:
        ...
        OrientationFromComplementary = getOrientationFromComplementaryFilter(Physw, PhysAcc, ViconNewRots, ValidMask, dtar, alpha=0.9)
        ...
        OrientationFromMadgwick = getOrientatiomfromMadgwickFilter(Physw, PhysAcc, ViconNewRots, ValidMask, dtar, beta=0.4)
